...
def joinFactors(factors: List[Factor]):
    ...
    # para cada atribuicao possivel
    for assignment in newFactor.getAllPossibleAssignmentDicts():  
        # inicia probabilidade
        p = 1  
        
        # multiplica probabilidades de cada fator
        for factor in factors:  
            p *= factor.getProbability(assignment)  
            
        # define probabilidade no novo fator
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        "*** YOUR CODE HERE ***"
        # cria novo fator sem a variavel a eliminar
        ...
        # dominio da variavel a eliminar
        eliminateDomain = factor.variableDomainsDict()[eliminationVariable]
    
        # para cada atribuicao no novo fator
        for assignment in newFactor.getAllPossibleAssignmentDicts():
            # inicia soma
            p = 0
            # copia atribuicao
            assginmentWithEliVar = assignment.copy()
            # soma probabilidades para cada valor da variavel eliminada
