...
def inferenceByVariableEliminationWithCallTracking(callTrackingList=None):
    ...
    def inferenceByVariableElimination(bayesNet: bn, queryVariables: List[str], evidenceDict: Dict, eliminationOrder: List[str]):
        ...
        "*** YOUR CODE HERE ***"
        # pega todas as tabelas de probabilidade com evidencias
        factorsList = bayesNet.getAllCPTsWithEvidence(evidenceDict)

        # junta fatores por variavel
        for variable in eliminationOrder:
            # junta fatores para a variavel
            factorsList, factor = joinFactorsByVariable(factorsList, variable)
            # se tem poucas variaveis, pula
            if len(factor.unconditionedVariables()) <= 1:
                continue
            # elimina a variavel e adiciona
...
class DiscreteDistribution(dict):
    ...
    def normalize(self):
        ...
        # se total e 0 ou 1, sai
        if total == 0 or total == 1:
            return
        
        # divide cada valor pelo total
    ...
    def sample(self):
        ...
        for key in self.keys():
            ...
            # se passou o numero aleatorio, retorna a chave
            if total > p:
                return key
        #raiseNotDefined()
        "*** END YOUR CODE HERE ***"
...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance: int, pacmanPosition: Tuple, ghostPosition: Tuple, jailPosition: Tuple):
        ...
        """
        "*** YOUR CODE HERE ***"
        # se fantasma esta na prisao
        if ghostPosition == jailPosition:
            # retorna 1 se distancia e None, senao 0
        ...
        # retorna probabilidade da observacao
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation: int, gameState: busters.GameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        # pega posicao do Pacman
        pacmanPosition = gameState.getPacmanPosition()
        
        # pega posicao da prisao
        jailPosition = self.getJailPosition()
        
        # pega distribuicao atual de crencas
        currentBeliefs = self.getBeliefDistribution()
        
        # cria nova distribuicao
        updatedBeliefs = DiscreteDistribution()

        # para cada posicao possivel do fantasma
        for ghostPosition in self.allPositions:
            # calcula nova crenca baseada na observacao
    ...
    def elapseTime(self, gameState: busters.GameState):
        ...
        # cria nova distribuicao de crencas
        newBeliefs = DiscreteDistribution()
        
        # para cada posicao antiga
        for oldPos in self.allPositions:
            
            # pega distribuicao de novas posicoes
            newPosDist = self.getPositionDistribution(gameState, oldPos)
            # probabilidade da posicao antiga
            oldProb = self.beliefs[oldPos]
            
            # para cada nova posicao
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState: busters.GameState):
        ...
        # numero de posicoes legais
        numPost = len(self.legalPositions)
        
        # distribui particulas uniformemente
    ...
    def getBeliefDistribution(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        # cria distribuicao de crencas
        beliefs = DiscreteDistribution()
        
        # conta cada particula
    ...
    def elapseTime(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        # lista para novas particulas
        newParticles = []
        # para cada particula atual
        for part in self.particles:
            
            # pega distribuicao de novas posicoes
            newPosDist = self.getPositionDistribution(gameState, part)
            # amostra nova posicao
