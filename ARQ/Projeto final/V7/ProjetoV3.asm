...
.model small ;   
.stack 100h ;incializar sagmento pilha com 100h que corresponde a 256 byts
...
macro ImprimirString msg ; macro que imprima uma string
    ...
    macro somar soma        ;macro somar com o parametro soma
        ...
        mov cx, 10d          ; Define o contador para o numero de elementos no vetor
    ...
    macro maiorE maior  ;macro maiorE com o parametro maior
        ...
        mov cx, 9d     ; mover cx 10 em decimal para realizar um loop 10 vezes
        xor bx, bx
        maiorElemento:   ; nome ou label do meu loop
            ...
            jle m          ; fazer jg onde salta se al maior ou seja salta se o valor de ah for maior que al
    ...
    macro ordenar
        ...
        mov i, 00h  ; mover para i 00h
        mov cx, 10d    ; mover para cx 10d
        xor ax, ax      ; zerar ax
        xor bx, bx      ; zerar bx
        
        exterior:     ; rotulo exterior
...
main:
    ...
    infinito:     ; rotulo infinito
        ...
        comparar op
                          ; chamar macro comparar com o paramentro op

        inserirNota:             ; rotulo inserirNota
            mov controlo, 01h
            call NewLine           ;chama o procedimento mudanca de linha
            ...
            Print "Introduza as notas"   ; imprima na tela a mensagem "Introduza as notas"     
            ler:  
                erro:            ; rotulo erro
                      call NewLine    ;chama o procedimento mudanca de linha
    ...
    jmp infinito  ; saltar para o rotulo infinito
        ...
        MaiorNota:       ; rotulo maiorNota
                cmp controlo, 00h
                je okE0
                    
                maiorE maior     ;chamar macro maiorE com parametro maior
                call NewLine       ;chama o procedimento mudanca de linha
                Print "Aluno: "
                add pos, 01h
                imprimir2digito pos
